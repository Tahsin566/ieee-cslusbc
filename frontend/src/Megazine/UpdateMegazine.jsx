...
const UpdateMegazine = () => {
    ...
    const getSingleMagazine = async (id) => {
        try {
            ...
            setMegazineData({
                ...
                publicationDate: data.magazine.publicationDate,
                issueNumber: data.magazine.issueNumber,
                volumeNumber: data.magazine.volumeNumber,
                category: data.magazine.category,
                author: data.magazine.author,
            })
            setLoading(false);
        }
        catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch(`${BASE_URL}/magazine/update-magazine`, {
                method: "POST",
                body: formData,
                credentials: "include",
            });
    ...
    return (
        user?.role === "admin" ? <div className="bg-gray-50 min-h-screen py-12">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <p className="text-center text-gray-600 mb-10">Update a magazine to our platform. Please fill in all required information carefully.</p>
