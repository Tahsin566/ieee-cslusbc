    ...
    const [imagePreview, setImagePreview] = useState(null);
        ...
        const getSingleEvent = async (id) => {
            try {
                ...
                setFeatured(data.event.isFeatured);
        ...
        const handleSubmit = async(e) => {
            ...
            try {
                const response = await fetch(`${BASE_URL}/event/update-event`, {
                    method: "POST",
                    body: formData,
                    credentials: "include",
                });
    ...
    return (
        user?.role === 'admin' ? <div className="bg-gray-50 min-h-screen py-12">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                            ...
                            <p className="text-center text-gray-600 mb-10">Update an existing event for IEEE CS LU SB Chapter members and participants. Please fill in all required information.</p>
