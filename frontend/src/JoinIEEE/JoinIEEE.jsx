            ...
            <div className="bg-white p-8 w-full max-w-3xl shadow-lg rounded">
                ...
                <form className="space-y-6">
                    <div>
                        ...
                        <label className="block text-sm font-medium text-gray-700 mt-4">Department, Rank & Section</label>
                        <input type="text" required className="w-full mt-1 p-2 border rounded" />
                    ...
                    <button type="submit" className="w-full bg-[#045C99] hover:bg-yellow-600 text-white font-medium py-2 px-4 rounded">
                        Submit Application
                    </button>
                </form>
            </div>
