...
const AddNews = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if(!(news.title && news.author && news.markdown && news.newsImage && news.category)){
    ...
    return (
        user?.role === "admin" ? <div className="bg-gray-50 min-h-screen py-12">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <h1 className="text-3xl md:text-4xl font-bold text-center text-[#045C99]   -600 mb-2">Add News</h1>
